...
docker run -e LICENSE=accept -e LANG --privileged -v omsruntime:/images  -idt --name omsruntime cp.icr.io/cp/ibm-oms-enterprise/om-base:${INSTALL_VERSION}
...
cp ${PRESENT_WORK_DIR}/opt/ssfs/runtime/dbjar/jdbc/postgresql/postgresql.jar ${PRESENT_WORK_DIR}/ThirdPartyJars/
